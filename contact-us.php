...
<!-- Topbar End -->
        ...
        <div class="page-content">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12 col-sm-12">
                                <div class="contact-info block-shadow bg-white bg-center p-a40"
                                    style="background-image:url('./assets/images/bg/bg-map.png')">
                                    <div>
                                        <!-- TITLE START -->
                                        ...
                                        <div class="section-head">
                                            <div class="sx-separator-outer separator-left">
                                                <div class="sx-separator bg-white bg-moving bg-repeat-x"
                                                    style="background-image: url('./assets/images/bg/cross-line2.png'); background-position: -2284px 0px;">
                                                    <h3 class="sep-line-one"> Contact</h3>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sx-icon-box-wraper left p-b30">
                                            ...
                                            <div class="icon-content">
                                                ...
                                                <p>Interiorspace2019@gmail.com</p>
                                            </div>
                                        </div>
                                        ...
                                        <div class="sx-icon-box-wraper left">
                                            ...
                                            <div class="icon-content">
                                                ...
                                                <p>1-7-692/1, Adalath Circle, Hanamkonda, Warangal Urban., Warangal,
                                                    Telangana.506001.</p>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="maps">
                <iframe
                    src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3794.616730652032!2d79.54656257867131!3d17.996559939160413!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a334ff5832e6abf%3A0x104cca8d70b0c8c7!2sInterior%20space!5e0!3m2!1sen!2sin!4v1715944180729!5m2!1sen!2sin"
